...
public class Conector {
	 ...
	 private static final String JDBC_URL="jdbc:mysql://database-enki.mysql.database.azure.com:3306/enki?use_SSL=false&serverTimezone=America/Bogota"; 
	 private static final String JDBC_USER = "enkicom@database-enki"; 
	 private static final String JDBC_PASSWORD = "T-G8m*A6";
