...
public class MailUp {
	...
	private void init() {
		...
		properties.put("mail.smtp.mail.sender", "sonar.deeploy@gmail.com");
		properties.put("mail.smtp.user", "sonar.deeploy");
		properties.put("mail.smtp.password", "dPfFUGGs@xPx*");
	...
	public void sendEmail(ArrayList<String> correos, String asunto, String cuerpo, String fecha,Integer code,
		...
		String BODY = String.join(System.getProperty("line.separator"), "<html>", "<head>",
				...
				"<html>\r\n" + "  <head>\r\n" + "\r\n" + "    </head>\r\n" + "  <body>\r\n"
						...
						+ "      <tr>\r\n"
						+ "          <td colspan='2' align='center' bgcolor='#22E911'><strong>Informe de Link Nuevamente Arriba</strong></td>\r\n"
	...
	public void sendEmailExterno(ArrayList<String> correos, String asunto, String cuerpo, String fecha,Integer code,
		...
		String BODY = String.join(System.getProperty("line.separator"), "<html>", "<head>",
				...
				"<html>\r\n" + "  <head>\r\n" + "\r\n" + "    </head>\r\n" + "  <body>\r\n"
						...
						+ "      <th bgcolor='#198754'>Descripción</th>\r\n" + "    </tr>\r\n" + "\r\n"
						+ "    <tbody>\r\n" + "        <tr>\r\n" + "          <td>Anuncio</td>\r\n" + "          <td>"
						+ estadoLinkExterno.getLink_externo().getDescripcion() + "</td>\r\n" + "        </tr>\r\n"
						+ "        <tr>\r\n" + "          <td>Link</td>\r\n" + "          <td bgcolor='#22E911'>"
						+ estadoLinkExterno.getLink_externo().getUrl() + "</td>\r\n" + "        </tr>\r\n"
						
						+ "        <tr>\r\n" + "          <td>Cuenta Facebook</td>\r\n" + "          <td>"
						+ estadoLinkExterno.getLink_externo().getCuenta().getNombreCuenta() + "</td>\r\n" + "        </tr>\r\n"
						+ "        <tr>\r\n" + "          <td>Fecha y Hora</td>\r\n" + "          <td>" + fecha
						+ "</td>\r\n" + "        </tr>\r\n" + "        <tr>\r\n" + "          <td>Status</td>\r\n"
						+ "          <td>" + code + " - " + estadoLinkExterno.getMensaje()+ "</td>\r\n"
						+ "        </tr>\r\n" + "\r\n" + "\r\n" + "    </tbody>\r\n" + "    </table>\r\n"
						+ "    <br/>\r\n"
						+ "    <img src='https://static1.squarespace.com/static/5ce88653d84296000124515a/t/5ce93ca6ee6eb002e7b992ef/1614802124137/?format=1500w' width='350px' >\r\n"
						+ "  </body>\r\n" + "</html>");
