package com.monitor.bankendmonitoreoLinks.google;
...
/**
* The OAuth2 scope for the Ad Manager API.
*/
public static final String AD_MANAGER_API_SCOPE = "https://www.googleapis.com/auth/dfp";

/**
* Scopes to include in the authorization request. Add to this list any additional scopes you want
* to include.
*/
private static final List<String> SCOPES = Arrays.asList(AD_MANAGER_API_SCOPE);
